...
const CreateQuiz = () => {
  ...
  const handleGenerateAI = async () => {
    ...
    const progressInterval = setInterval(() => {
      ...
      if (currentProgress >= 99) clearInterval(progressInterval);
    }, 150);
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-slate-200/50 dark:bg-slate-800 p-1.5 rounded-full flex gap-1 shadow-inner">
            <button
              ...
              className={`px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 ${creationMode === 'manual'
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 flex items-center gap-2 ${creationMode === 'ai'
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-700 p-10 w-full max-w-md mx-4">
            ...
            <div className="grid grid-cols-3 gap-2 mt-6">
              {[
                ...
                <div key={i} className={`text-center p-2 rounded-xl transition-all duration-300 ${progress > stage.threshold
